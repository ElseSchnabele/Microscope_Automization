...
FILENAME = 'camera_test.tif'  # The filename of the TIFF
...
with TLCameraSDK() as sdk:
    ...
    with sdk.open_camera(cameras[0]) as camera:
        ...
        camera.image_poll_timeout_ms = 10000  # 2 second timeout
        camera.arm(2)
        ...
        while frames_counted < NUMBER_OF_IMAGES:
            ...
            plt.colorbar()  # Falls du eine Farbskala anzeigen möchtest
            plt.show()
            ...
            with tifffile.TiffWriter(OUTPUT_DIRECTORY + os.sep + FILENAME, append=False) as tiff:
                """
